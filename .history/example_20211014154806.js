...
console.log("is nullish equals  false" + (nullish==false));
console.log("is undefinesh equals  false" + (undefinesh==false));
console.log("is stringzerolength equals  false" + (stringzerolength==false));
