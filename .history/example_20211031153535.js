...
// Array.prototype.filterBy = function(property_name,value) {
//     return this.filter((x)=>{
//         return x[property_name] === value;
//         // return x[property_name] === value
//     })
//   };
//   Array.prototype.logtoconsole = function(){
//       console.log(this);
//   }
// var fruits = [{name:"Banana",color:"Yellow"}, {name:"Orange",color:"Orange"},{name: "Apple",color:"Green"},{name: "Mango",color:"Yellow"}];

// console.log(fruits.filterBy('weight',undefined));
// let a = "0";
// let b =0;
// console.log("is a and b equal", a===b)
// let g = {};
...
// const db = require("./app/modules/db.js");
// db.query("select * from users",(err,resut)=>{
//     console.log(err);
//     console.log(resut);
// })