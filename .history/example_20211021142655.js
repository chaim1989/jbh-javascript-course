...
Array.prototype.myOFruit = function(property_name,value) {
    return this.filter((x)=>{
        x.property_name
        return x[property_name] === "O"
    })
  };
var fruits = [{name:"Banana",prop,color:"Yellow"}, {name:"Orange",color:"Orange"},{name: "Apple",color:"Green"},{name: "Mango",color:"Yellow"}];
