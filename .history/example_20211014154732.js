...
console.log("is zero equals  " + (zero==false));
console.log("is nullish equals  " + (nullish==fals)e);
console.log("is undefinesh equals  " + (undefinesh==false);
console.log("is stringzerolength equals  " + (stringzerolength==false));
